module InvoicesHelper
  ...
  def header_tags
    return stylesheet_link_tag("invoice.css", :plugin => "redmine-invoice-plugin", :media => 'all') +
      stylesheet_link_tag("invoice_print.css", :plugin => "redmine-invoice-plugin", :media => 'print')
  end
end
